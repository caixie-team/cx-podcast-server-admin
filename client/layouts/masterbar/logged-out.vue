<template>
  <!--<masterbar>-->
    <!--<item class="c-masterbar__item-logo">-->
      <!--<svg style="display:none;" height="72" width="72" viewBox="0 0 72 72">-->
        <!--<path-->
      ...
      <!--<span class="c-masterbar__item-content">-->
        <!--<img src="https://nuxtjs.org/_nuxt/img/logo_nav.171838c.png" style="width: 110px;">-->
      <!--</span>-->
    <!--</item>-->
  <!--</masterbar>-->
</template>
