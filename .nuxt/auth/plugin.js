...
export default function (ctx, inject) {
  ...
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"http://127.0.0.1:5000/auth/login","method":"post","propertyName":"result.token"},"logout":{"url":"http://127.0.0.1:5000/auth/logout","method":"post"},"user":{"url":"http://127.0.0.1:5000/auth/user","method":"get","propertyName":"result"}},"_name":"local"}))
